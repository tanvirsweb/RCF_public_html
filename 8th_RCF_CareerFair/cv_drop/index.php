<?php
$current_page_name = 'career_fair_8th';
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text">
                    ...
                    <p>
                      Drop your CV for 8th RCF Career Fair
                    </p>
                </div>
            </div>
        </div>
                ...
                <form id="cv_drop_form" name="contactForm" onsubmit="return false" novalidate method="post" enctype="multipart/form-data" action="./cv_drop_submit.php">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control border px-2" id="company"  name="company">
                            ...
                            <option value="bjit ltd">BJIT Ltd</option>
                            <option value="bsrm">BSRM</option>
                            <option value="crown cement">Crown Cement</option>
                            <option value="earthmoving solution ltd">Earthmoving Solution Ltd</option>
