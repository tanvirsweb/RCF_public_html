...
<div class="highPerf" id="teamBranding">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-12">
                <h6>Formed Year: 2020 </h6>
                <h1>High Performance Team</h1>
                <h4>RUET Career Forum</h4>
                <br>
                <h6 class="title_text d-block">
                RCF's High Performance team is the team who work for the development of RUET Career Forum (RCF). It identifies the internal and external problem of RUET Career Forum (RCF) and try to solve those things in a specific manner. They do research from the other club, societies all around the world and ask RUET Career Forum authority for the permission to execute. Then if the authority gives permission to execute the idea , they do the rest which helps to develop RCF.
                </h6>
                <br>
            </div>
                ...
                <div class="row mt-60 pb-4">
                    <div class="col-lg-4 col-md-6 col-12 mt-3">
                        <div class="serv-section-2">
                            ...
                            <div class="serv-section-desc">
                                <h4>Connecting Other clubs</h4>
                                <h5 class="font-weight-lighter">
                                Connect RUET Career Forum through out the other clubs or societies of Bangladesh.
                                </h5>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-3">
                        <div class="serv-section-2">
                            ...
                            <div class="serv-section-desc">
                                <h4>Research</h4>
                                <h5 class="font-weight-lighter">
                                Doing research from the other clubs and society activities
                                </h5>
                            </div>
                            <div class="section-heading-line-left"></div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-3">
                        <div class="serv-section-2">
                            <div class="serv-section-2-icon"><i class="fa fa-briefcase"></i></div>
                            <div class="serv-section-desc">
                                <h4>Develop the club</h4>
                                <h5 class="font-weight-lighter">
                                Executing all the problematic issues.
                                </h5>
                            </div>
                            <div class="section-heading-line-left"></div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-3">
                        <div class="serv-section-2">
                            <div class="serv-section-2-icon"><i class="fa fa-briefcase"></i></div>
                            <div class="serv-section-desc">
                                <h4>Solve Internal Problems</h4>
                                <h5 class="font-weight-lighter">
                                Helps to solve the member internal issues regarding the club.
                                </h5>
                            </div>
                            <div class="section-heading-line-left"></div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-3">
                        <div class="serv-section-2">
                            <div class="serv-section-2-icon"><i class="fa fa-briefcase"></i></div>
                            <div class="serv-section-desc">
                                <h4>Solve External Problems</h4>
                                <h5 class="font-weight-lighter">
                                Helps to solve the member external issues regarding the club.
                                </h5>
                            </div>
                            <div class="section-heading-line-left"></div>
                        </div>
