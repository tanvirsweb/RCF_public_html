...
move_uploaded_file($file_tmp, "./" . $company . "/" . "[" . $next_id . "] " . $file_name);
// if($company === "bjit ltd"){
//     move_uploaded_file($file_tmp,"./BJIT Ltd/"."[".$next_id."] ".$file_name);
// }
// if($company === "bsrm"){
//     move_uploaded_file($file_tmp,"./BSRM/"."[".$next_id."] ".$file_name);
// }
// if($company === "crown cement"){
//     move_uploaded_file($file_tmp,"./Crown Cement/"."[".$next_id."] ".$file_name);
// }
// if($company === "earthmoving solution ltd"){
//     move_uploaded_file($file_tmp,"./Earthmoving Solution Ltd/"."[".$next_id."] ".$file_name);
// }
// if($company === "mentors"){
//     move_uploaded_file($file_tmp,"./Mentors/"."[".$next_id."] ".$file_name);
// }
// if($company === "pran"){
//     move_uploaded_file($file_tmp,"./Pran/"."[".$next_id."] ".$file_name);
// }
// if($company === "rfl"){
