<?php
$current_page_name = 'career_fair_9th';
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text">
                    ...
                    <p>
                        Drop your CV for 9th RCF Career Fair
                    </p>
                </div>
            </div>
        </div>
                ...
                <form id="cv_drop_form" name="contactForm" onsubmit="return false" novalidate method="post" enctype="multipart/form-data" action="./cv_drop_submit.php">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control border px-2" id="company" name="company">
                            ...
                            <option value="Earthmoving_Solutions_Ltd">Earthmoving Solutions Ltd.</option>
                            <option value="RH_corporation_Ltd">RH corporation Ltd.</option>
                            <option value="pran">Pran</option>
                            <option value="rfl">RFL</option>
                            <option value="Bevy_commerce">Bevy commerce</option>
                            <option value="Ecologyx">Ecologyx</option>
                            <option value="Walton">Walton</option>
                            <option value="Navana">Navana</option>
                            <option value="Huawei">Huawei</option>
                            <option value="Meghna_group_of_Industries">Meghna group of Industries</option>
                            <option value="Star_ceramics">Star ceramics</option>
                            <option value="Renata_ltd">Renata ltd.</option>
                            <option value="Real_star_properties">Real star properties</option>
                        </select>
                        <div class="invalid-feedback" id="companyInvalidText"></div>
                    </div>
                    <div class="custom-file" id="cv_drop">
                        <input type="file" class="custom-file-input" name="cv_drop_file" id="cv_drop_file" accept=".pdf">
