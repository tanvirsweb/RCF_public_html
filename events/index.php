                ...
                <form method="GET">
                    <div class="form-group pt-2">
                        ...
                        <select name="year" class="custom-select" id="year">
                            <option <?php if(isset($_GET['year']) && $_GET['year']== 'all') {echo 'selected';}?>
                                value="all">All</option>
                            <option <?php if(isset($_GET['year']) && $_GET['year']== '2020') {echo 'selected';}?>
                                value="2020">2020</option>
                            <option <?php if(isset($_GET['year']) && $_GET['year']== '2019') {echo 'selected';}?>
                                value="2019">2019</option>
                            <option <?php if(isset($_GET['year']) && $_GET['year']== '2018') {echo 'selected';}?>
                                value="2018">2018</option>
                            <option <?php if(isset($_GET['year']) && $_GET['year']== '2017') {echo 'selected';}?>
                                value="2017">2017</option>
                            <option <?php if(isset($_GET['year']) && $_GET['year']== '2016') {echo 'selected';}?>
                                value="2016">2016</option>
                            <option <?php if(isset($_GET['year']) && $_GET['year']== '2015') {echo 'selected';}?>
                                value="2015">2015</option>
                            <option <?php if(isset($_GET['year']) && $_GET['year']== '2014') {echo 'selected';}?>
